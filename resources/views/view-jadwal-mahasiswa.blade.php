...
@section('konten')
    <a type="Button" class="btn btn-inverse-primary" href="daftarSidang">Daftar Sidang </a>
    <a type="Button" class="btn btn-primary" href="viewJadwalMahasiswa"> Jadwal Sidang </a>
    <div class="row">
