...
@section('konten')
    <h4>Edit Profile</h4>
    <form action="/updateDosen/{{ $viewDsn->nid }}" method="POST" enctype="multipart/form-data">
        {{ csrf_field() }}
        <table>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" id="name" value="{{ $viewDsn->name }}"> <br />
                @error('name')
                    <div class="alert alert-danger alert-dismissible" style="margin-top: -20px" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" id="email" value="{{ $viewDsn->email }}"> <br />
                @error('email')
                    <div class="alert alert-danger alert-dismissible" style="margin-top: -20px" role="alert">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
            ...
            <div class="form-group">
                ...
                <select class="custom-select" id="id_prodi" name="id_prodi">
                    <option value="{{ $viewDsn->id_prodi }}">{{ $viewDsn->prodi['nama_prodi'] }}</option>
            ...
            <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                    <input type="text" class="form-control file-upload-info" disabled placeholder="{{ $viewDsn->foto }}">
